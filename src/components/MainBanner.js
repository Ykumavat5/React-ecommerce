...
const MainBanner = () => {
    ...
    useEffect(() => {
        const fetchData = async () => {
            ...
            if (response.success) {
                ...
                const mainBanner = banners.find(b => b.name === "Main Banner") || null;
                setBanner(mainBanner);
            } else {
                console.error("Failed to fetch main banner:", response.error);
            }
        };
    ...
    return (
        <section
            style={{
                backgroundImage: `url(${banner.media})`,
                ...
                <div className="row">
                    <div className="col-lg-6 pt-5 mt-5">
                        <h2 className="display-1 ls-1">
                            <span className="fw-bold text-primary">Organic</span> Foods at your <span className="fw-bold">Doorsteps</span>
                        </h2>
                ...
                <div className="row row-cols-1 row-cols-sm-3 row-cols-lg-3 g-0 justify-content-center">
                        ...
                        <div className="card border-0 bg-primary rounded-0 p-4 text-light">
                            <div className="row">
                                <div className="col-md-3 text-center">
                                    <svg width="60" height="60"><use href="#fresh" /></svg>
                                </div>
                    ...
                    <div className="col">
                        <div className="card border-0 bg-secondary rounded-0 p-4 text-light">
                            <div className="row">
                                <div className="col-md-3 text-center">
                                    <svg width="60" height="60"><use href="#organic" /></svg>
                                </div>
                                <div className="col-md-9">
                                    <div className="card-body p-0">
                    ...
                    <div className="col">
                        <div className="card border-0 bg-danger rounded-0 p-4 text-light">
                            <div className="row">
                                <div className="col-md-3 text-center">
                                    <svg width="60" height="60"><use href="#delivery" /></svg>
                                </div>
                                <div className="col-md-9">
                                    <div className="card-body p-0">
